...
public class BlacklistLookup extends IRCCommand {
    ...
    public BlacklistLookup() {
        super(GeneralUtils.toArray("blacklistlookup sbl spambl ibl ircbl"), 5, "blacklistlookup [irc/spam] [ip/domain/user]", "Looks up a domain or ip in blacklist database", false);
    }
